readonly branch=17
readonly aosp_tag_old=android-17.0.0_r1
readonly aosp_tag=android-17.0.0_r1
...
readonly aosp_forks=(
    ...
    platform_frameworks_hardware_interfaces
    ...
    platform_packages_modules_Telephony
