...
parallel --use-cores-instead-of-threads -q script/generate_delta.sh ::: raven oriole barbet redfin bramble sunfish coral flame bonito sargo crosshatch blueline ::: $@ ::: $SOURCE
