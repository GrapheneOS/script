...
parallel --use-cores-instead-of-threads -q script/generate_delta.sh ::: lynx cheetah panther bluejay raven oriole barbet redfin bramble sunfish coral flame ::: $@ ::: $SOURCE
