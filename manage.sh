...
branch=10
aosp_version=QQ1A.200205.002 # version to use for build id and tag
aosp_version_real=QQ1A.200205.002 # real base version
...
declare -A kernels=(
  [google_wahoo]=android-10.0.0_r0.36 # February 2019
  [google_crosshatch]=android-10.0.0_r0.40 # February 2019
