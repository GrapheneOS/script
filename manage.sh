...
declare -A kernels=(
    # December 2021
    [google_crosshatch]=android-12.0.0_r0.21
    [google_crosshatch_drivers_staging_qcacld-3.0]=android-12.0.0_r0.21
    [google_crosshatch_techpack_audio]=android-12.0.0_r0.21

    # December 2021
    [google_coral]=android-12.0.0_r0.22
    [google_coral_drivers_input_touchscreen_fts_touch_s5]=android-12.0.0_r0.22
    [google_coral_drivers_staging_qcacld-3.0]=android-12.0.0_r0.22
    [google_coral_techpack_audio]=android-12.0.0_r0.22

    # December 2021
    [google_redbull]=android-12.0.0_r0.24
    [google_redbull_drivers_staging_qcacld-3.0]=android-12.0.0_r0.24
    [google_redbull_techpack_audio]=android-12.0.0_r0.24
    [google_redbull_arch_arm64_boot_dts_vendor]=android-12.0.0_r0.24

    # December 2021
    [google_barbet]=android-12.0.0_r0.25
    [google_barbet_drivers_staging_qcacld-3.0]=android-12.0.0_r0.25
    [google_barbet_techpack_audio]=android-12.0.0_r0.25
    [google_barbet_arch_arm64_boot_dts_vendor]=android-12.0.0_r0.25
...
for repo in "${aosp_forks[@]}"; do
    ...
    if [[ -n $build_number ]]; then
        ...
        if [[ $repo == @(platform_build|platform_external_android-nn-driver|platform_external_armnn|platform_frameworks_base|platform_manifest|device_google_gs101|device_google_gs101-sepolicy|device_google_raviole) ]]; then
